...
dataset = pd.read_csv('NWFPDistrict.csv') #Reading from folder where csv file is
...
#Splitting the dataset, 13% for test set
...
print(regressor.predict([[2020, 140]]))
